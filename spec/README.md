...
| File | Purpose |
|------|---------|
| [`SPEC.md`](./SPEC.md) | Normative specification (v0.3.0). Defines architecture, agent routing, phase pipeline, convergence protocol, failure modes, configuration, conformance, and implementation-defined items. |
